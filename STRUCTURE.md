...
|--         baseline-runs
|--           2026-05-11-haiku-4-5.jsonl
|--           2026-05-11-opus-4-7.jsonl
|--           2026-05-11-sonnet-4-6.jsonl
|--           2026-08-12-haiku-4-5-post-import-wave.jsonl
|--         fixtures-held-out.jsonl
|--         fixtures.jsonl
|--         .gitignore
|--         harness.mjs
...
|--             fixtures
|--               mars-demo.jsonl
|--               mars-multilingual.jsonl
|--               mars-solo.jsonl
|--               persona-routing.jsonl
|--               venus.jsonl
|--             judge.mjs
|--             mars-eval.mjs
...
|--           adversarial.jsonl
|--           all.jsonl
|--           bold-name-no-time.jsonl
|--           bold-time-dash.jsonl
|--           claude-code.jsonl
|--           imessage.jsonl
|--           imessage-time-only-12h.jsonl
|--           irc-classic.jsonl
|--           irc-weechat.jsonl
|--           matrix-element.jsonl
|--           signal-export.jsonl
|--           teams-export.jsonl
|--           telegram-bracket.jsonl
|--           whatsapp-iso.jsonl
|--           whatsapp-us.jsonl
|--         dream-budget-schema-v1.jsonl
|--         e5-lease-cap-ab
