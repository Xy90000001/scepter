...
export class SimpleCamera {
    constructor(sce, onload, jsonIn) {
        ...
        this.comp_screenEffects.setGPUFor( sce.canvas,
                                    {"float4* RGB": () => {return new Float32Array(_sce.dimensions.width*_sce.dimensions.height*4);}},
                                    {"type": "KERNEL",
                                    ...
                                    "blendDstMode": Constants.BLENDING_MODES.ZERO}, (function() {
                this.comp_screenEffects.onPostProcessKernel(() => {
