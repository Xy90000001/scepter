	...
	*/
	...
	tick() {
		if(this.activeCamera != null) {
            ...
            //component.gpufG.resetGLConf();



            let comp_camera_gpu = this.activeCamera.getComponent(Constants.COMPONENT_TYPES.GPU);
			if(comp_camera_gpu !== undefined && comp_camera_gpu !== null && comp_camera_gpu.gpufG != null) {
                //comp_camera_gpu.gpufG.resetGLConf();
            ...
            for(let n=0, fn = this.nodes.length; n < fn; n++) {
                if(this.nodes[n] !== this.activeCamera) {
                    for(let key in this.nodes[n].getComponents()) {
                        ...
                        if(component.gpufG !== undefined && component.gpufG !== null) {
                            if(typeof Module === "undefined") {
                                ...
                                console.log("\n\n[SCEJS] CLEAR COMPONENTS");
                                component.gpufG.clearOutputFrameBuffers();
                            }
                        }
                    }
                }
