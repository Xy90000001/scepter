...
export class PanelNumberGenerator {
    constructor() {
        ...
        this.panel = new DraggabillyS({ "id": 'DIVID_PanelNumberGenerator',
                                        "paneltitle": 'NUMBER GENERATOR'});
        this.panel.target.style.width = "500px";
    }
